  ...
  <body>
    ...
    <div class="d-flex align-items-center justify-content-center ht-100v">
      <video id="headVideo" class="pos-absolute a-0 wd-100p ht-100p object-fit-cover" autoplay muted loop>
        <source src="{{asset('backend/videos/video.mp4')}}" type="video/mp4">
        <source src="{{asset('backend/videos/video.ogv')}}" type="video/ogg">
        <source src="{{asset('backend/videos/video.webm')}}" type="video/webm">
      </video><!-- /video -->
